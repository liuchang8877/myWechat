			...
			<div class="tc-box">
	        	...
	        	<div class="comment-ranking">
	        		...
	        		<?php if(is_array($last_comments)): foreach($last_comments as $key=>$vo): ?><div class="comment-ranking-inner">
	                        ...
	                        <a href="/thinkcmfx2.1.0/<?php echo ($vo["url"]); ?>#comment<?php echo ($vo["id"]); ?>">查看原文</a>
			        	...
			        	<dl class="dl-horizontal">
				            <dt>
					            <a class="img-wraper" href="<?php echo leuu('article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>">
					            	<?php if(empty($smeta['thumb'])): ?><img src="/thinkcmfx2.1.0/themes/simplebootx/Public/images/default_tupian4.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
									<?php else: ?> 
